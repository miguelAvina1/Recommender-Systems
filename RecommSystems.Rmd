...
```
<center>**Figure 32. Histogram of the 'longitude' variable**</center>
<br>
<br>
```{r}
...
```
<center>**Figure 34.Graph of latitude and longitude**</center>
<br>
<br>
...
```
<center>**Figure 35.Graphic of cuisine**</center>
<br>
<br>
```{r}
...
```
<center>**Figure 36. Boxplot of cuisine**</center>
```{r}
t[which(t$freq %in% outvals),]
```

<center>**Figure 37. Kind of cuisine of the outliers in Fig. 36**</center>
<br>
<br>
<hr>
<div style="text-align: right"> Return to [Index] </div>
...
levels(places$city)
```
<center>**Figure 39. Levels for the 'city' variable after filling missing data with *revgeo* **</center>
